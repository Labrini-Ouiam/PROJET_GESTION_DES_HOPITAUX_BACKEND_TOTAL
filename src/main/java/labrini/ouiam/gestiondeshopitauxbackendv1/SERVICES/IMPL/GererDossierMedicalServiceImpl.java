...
public class GererDossierMedicalServiceImpl implements GererDossierMedicalService {
    ...
    private final GererDossierMedicalRepository gererDossierMedicalRepository;
    private final DossierMedicalRepository dossierRepository;
    private final UtilisateurRepository utilisateurRepository;

    public GererDossierMedicalServiceImpl(GererDossierMedicalRepository gererDossierMedicalRepository,
                                          DossierMedicalRepository dossierRepository,
                                          UtilisateurRepository utilisateurRepository) {
        this.gererDossierMedicalRepository = gererDossierMedicalRepository;
        this.dossierRepository = dossierRepository;
        this.utilisateurRepository = utilisateurRepository;
    }
    ...
    public GererDossierMedicalDTO createGestion(GererDossierMedicalDTO gestionDTO) {
        ...
        GererDossierMedical savedGestion = gererDossierMedicalRepository.save(gestion);
        return toDto(savedGestion);
    }

    @Override
    public GererDossierMedicalDTO getGestionById(Long id) {
        GererDossierMedical gestion = gererDossierMedicalRepository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException("GererDossierMedical", "id", id));
    ...
    @Override
    public List<GererDossierMedicalDTO> getGestionsByDossier(Long dossierId) {
        return gererDossierMedicalRepository.findByDossierMedical_IdDossierMedical(dossierId).stream()
                .map(this::toDto)
                .collect(Collectors.toList());
    }
    ...
    @Override
    public List<GererDossierMedicalDTO> getGestionsByUtilisateur(Long utilisateurId) {
        return gererDossierMedicalRepository.findByUtilisateur_Id(utilisateurId).stream()
                .map(this::toDto)
                .collect(Collectors.toList());
    }
    ...
    @Override
    public GererDossierMedicalDTO updateGestion(Long id, GererDossierMedicalDTO gestionDTO) {
        GererDossierMedical existingGestion = gererDossierMedicalRepository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException("GererDossierMedical", "id", id));
        ...
        GererDossierMedical updatedGestion = gererDossierMedicalRepository.save(existingGestion);
    ...
    public void deleteGestion(Long id) {
        GererDossierMedical gestion = gererDossierMedicalRepository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException("GererDossierMedical", "id", id));
        gererDossierMedicalRepository.delete(gestion);
    }
    ...
    private GererDossierMedicalDTO toDto(GererDossierMedical gestion) {
        ...
        if(gestion.getUtilisateur() != null) {
            dto.setUtilisateurId(gestion.getUtilisateur().getId());
